...
//        } while (!isGameOver(o));
    ...
    public static void randomMove()
    {
        ...
        if (isGameOver(o)){
            ...
            if(InputsController.timeline != null) {
                InputsController.timeline.stop();
                InputsController.timeline = null;
            }
            GameProperUI.autoMoveBox.setDisable(true);
        }
    }
